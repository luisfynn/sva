...
// TV
	...
	{	// 960x576i50
		...
		8,		// vdpulse_pos
		320,		// vdpulse_pos_bot
		1152, //		  1200, 	  // htotal_size // modified on 12Mar2014
		100, 	  // hactive_start
		1060, 	  // hactive_end
		65, 	  // hsync_start
		1, 	  // hsync_end
	...
	{	// 960x576p50 // added on 04Feb2014
		20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1153, //		1200,		// htotal_size // modified on 12Mar2014
		100,		// hactive_start
		1060,		// hactive_end
		65,		// hsync_start
		1,		// hsync_end
	...
	{	// 1280x480p60 // added on 04Mar2014
		20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1716,		// htotal_size
	...
	{	// 1280x576p50 // added on 04Mar2014
		20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1728,		// htotal_size
	...
	{	// 1440x480p60 // added on 04Mar2014
		20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1716,		// htotal_size
	...
	{	// 1440x576p50 // added on 04Mar2014
		20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1728,		// htotal_size
...
*/
{	// 800x480p60 //by hungry 2013.05.22 for cmx
	20,		// hdpulse_pos
		10,		// vdpulse_pos
		0,		// vdpulse_pos_bot
		1056,//858,		// htotal_size
		87,//90,		// hactive_start
		887,//810,		// hactive_end
		41,//63,		// hsync_start
		1,		// hsync_end
...
ROMDATA MDIN_DACSYNC_CTRL defMDINDACData[]		= {
	...
	{	// 1280x720p30
		{ 76,			// 0x00 : dac_sync_level_a                                
			...
			20,			// 0x09 : dac_heq_pulse_size                              
			41,			// 0x0A : dac_hsync_size                                  
			1650,			// 0x0B : dac_htotal_half_size                            
			1760,			// 0x0C : dac_hfp_interval                                
			260,			// 0x0D : dac_hbp_interval                                
			15<<12 |   1,	// 0x0E : dac_line_format1(15:12), dac_vstart_pos1(10:0)  
			0<<12 |   6,	// 0x0F : dac_line_format2(15:12), dac_vstart_pos2(10:0)  
			0<<12 |  26,	// 0x10 : dac_line_format3(15:12), dac_vstart_pos3(10:0)  
	...
	{	// 1280x720p25
		{ 76,			// 0x00 : dac_sync_level_a                                
			...
			20,			// 0x09 : dac_heq_pulse_size                              
			41,			// 0x0A : dac_hsync_size                                  
			1980,			// 0x0B : dac_htotal_half_size                            
			2420,			// 0x0C : dac_hfp_interval                                
			260,			// 0x0D : dac_hbp_interval                                
			15<<12 |   1,	// 0x0E : dac_line_format1(15:12), dac_vstart_pos1(10:0)  
			0<<12 |   6,	// 0x0F : dac_line_format2(15:12), dac_vstart_pos2(10:0)  
			0<<12 |  26,	// 0x10 : dac_line_format3(15:12), dac_vstart_pos3(10:0)  
	...
	{	// 1920x1080p24
	   { 76,			// 0x00 : dac_sync_level_a                                
		...
		307,			// 0x08 : dac_blank_level_br                              
		 22,			// 0x09 : dac_heq_pulse_size                              
		 45,			// 0x0A : dac_hsync_size                                  
	     1375,			// 0x0B : dac_htotal_half_size                            
		638,			// 0x0C : dac_hfp_interval                                
		133,			// 0x0D : dac_hbp_interval                                
		15<<12 |   1,	// 0x0E : dac_line_format1(15:12), dac_vstart_pos1(10:0)  
		 0<<12 |   6,	// 0x0F : dac_line_format2(15:12), dac_vstart_pos2(10:0)  
		 0<<12 |  42,	// 0x10 : dac_line_format3(15:12), dac_vstart_pos3(10:0)  
...
//	 Htot					                   H/V Polarity & ScanType                                       Hact  Vact
	...
	{ 864, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  704,  576},// 720x576i50
	...
	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  960,  480},// 960x480i60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  960,  576},// 960x576i50

	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  1280, 480},// 1280x480i60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  1280, 576},// 1280x576i50
	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  1440, 480},// 1440x480i60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_INTR,  1440, 576},// 1440x576i50
	...
	{2640, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1920, 1080},// 1920x1080p30		//add luisfynn(PINETRON Co.,LTD) 
	{2640, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1920, 1080},// 1920x1080p25		//add luisfynn(PINETRON Co.,LTD) 
	...
	{1792, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1366,  768},// 1366x768p60
...
//	 Htot					                   H/V Polarity & ScanType                                       Hact  Vact
	...
	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_PROG, 1280,  480},// 1280x480p60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_PROG, 1280,  576},// 1280x576p50
	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_PROG, 1440,  480},// 1440x480p60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_NEGATIVE_VSYNC|MDIN_SCANTYPE_PROG, 1440,  576},// 1440x576p50
	...
	{1792, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1366,  768},// 1366x768p60
	{1864, MDIN_NEGATIVE_HACT|MDIN_POSITIVE_VACT|MDIN_NEGATIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1400, 1050},// 1400x1050p60
	{2160, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1600, 1200},// 1600x1200p60
...
//	{{ 21, 22, 0, (0<<4)|1}, { 2700,  5000, 1728,  625}, {264,  22,  720,  288}, {3, 126, 3, 138,  19,  24,  2,  432}}, // 1440x576i@50(21,22)
	...
	{{	6,	7, 0, (1<<4)|1}, { 2700,  6000, 1716,  264}, {119,	18,  720,  240}, {3,  62, 2, 114,  15,	19,  4,  429}}, // 960x480i@60(6,7) // 28Dec2011
	{{ 21, 22, 0, (0<<4)|1}, { 2700,  5000, 1728,  313}, {132,	22,  720,  288}, {3,  63, 3, 138,  19,	12,  2,  432}}, // 960x576i@50(21,22) // 28Dec2011

	{{  2,  3, 0, (1<<4)|0}, { 3600,  6000, 1144,  525}, {122,  36,  720,  480}, {0,  62, 6,  60,  30,  16,  9,    0}}, // 960x480p@60(2,3)	// added on 04Feb2014
	{{ 17, 18, 0, (1<<4)|0}, { 3600,  5000, 1200,  625}, {132,  44,  720,  576}, {0,  64, 5,  68,  39,  12,  5,    0}}, // 960x576p@50(17,18) // added on 04Feb2014

	{{  2,  3, 0, (1<<4)|0}, { 3600,  6000, 1144,  525}, {122,  36,  720,  480}, {0,  62, 6,  60,  30,  16,  9,    0}}, // 1280x480p@60(2,3)	// added on 04Mar2014
	{{ 17, 18, 0, (1<<4)|0}, { 3600,  5000, 1200,  625}, {132,  44,  720,  576}, {0,  64, 5,  68,  39,  12,  5,    0}}, // 1280x576p@50(17,18) // added on 04Mar2014
	{{  2,  3, 0, (1<<4)|0}, { 3600,  6000, 1144,  525}, {122,  36,  720,  480}, {0,  62, 6,  60,  30,  16,  9,    0}}, // 1440x480p@60(2,3)	// added on 04Mar2014
	{{ 17, 18, 0, (1<<4)|0}, { 3600,  5000, 1200,  625}, {132,  44,  720,  576}, {0,  64, 5,  68,  39,  12,  5,    0}}, // 1440x576p@50(17,18) // added on 04Mar2014
