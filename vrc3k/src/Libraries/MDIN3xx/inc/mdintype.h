...
#define	ROMDATA				__attribute__ ((section(".rodata.mdin")))					// program(read-only) memory
...
//#define 	SYSTEM_USE_MCLK189			// for use 189MHz in memory clock	//by hungry 2013.06.07 for cmx
#endif
...
#define		RGB_GAIN_OFFSET_TUNE	1	// "1" for tune gain/offset, "0" for not tune
#define		SOURCE_CSC_STD_RANGE	0	// "1" for standard range, "0" for full range
...
#ifndef UARTprintf
#define 	UARTprintf	xprintf	
#endif

//#define		SYSTEM_USE_GRP_OSD			//by hungry 2013.04.10 G_OSD
