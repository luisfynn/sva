...
typedef	struct
{
	WORD	lower[128];		// coefficients of lower 32-phase of mfc filter
	WORD	upper[128];		// coefficients of upper 32-phase of mfc filter
...
typedef	enum {
	...
	VIDSRC_960x480i60,			// 960x480i 60Hz // added on 04Feb2014
	VIDSRC_960x576i50,			// 960x576i 50Hz // added on 04Feb2014

	VIDSRC_1280x480i60,			// 1280x480i 60Hz
	VIDSRC_1280x576i50,			// 1280x576i 50Hz
	VIDSRC_1440x480i60, 		// 1440x480i 60Hz
	VIDSRC_1440x576i50, 		// 1440x576i 50Hz

	VIDSRC_1280x720p60,			// 1280x720p 60Hz
	VIDSRC_1280x720p50,			// 1280x720p 50Hz
	VIDSRC_1280x720p30,			// 1280x720p 30Hz
	VIDSRC_1280x720p25,			// 1280x720p 25Hz	
	...
	VIDSRC_1920x1080p24,		// 1920x1080p 24Hz
	...
	VIDSRC_1366x768p60,			// 1366x768p 60Hz
	VIDSRC_1440x900p60,			// 1440x900p 60Hz

	VIDSRC_1600x1200p60,			// 1600x1200p 60Hz
	VIDSRC_1680x1050p60,			// 1680x1050p 60Hz
	VIDSRC_1920x1200p60,			// 1920x1200p 60Hz (RB)
...
typedef	enum {
	...
	VIDOUT_960x480i60,			// 960x480p 60Hz // added on 04Feb2014
	VIDOUT_960x576i50,			// 960x576p 50Hz // added on 04Feb2014
	
	VIDOUT_960x480p60,			// 960x480p 60Hz // added on 04Feb2014
	VIDOUT_960x576p50,			// 960x576p 50Hz // added on 04Feb2014
	
	VIDOUT_1280x480p60,			// 1280x480p 60Hz // added on 04Mar2014
	VIDOUT_1280x576p50,			// 1280x576p 50Hz // added on 04Mar2014
	VIDOUT_1440x480p60,			// 1440x480p 60Hz // added on 04Mar2014
	VIDOUT_1440x576p50,			// 1440x576p 50Hz // added on 04Mar2014
	
	VIDOUT_1280x720p60,		// 1280x720p 60Hz
	VIDOUT_1280x720p59,		// 1280x720p 59.94Hz
	VIDOUT_1280x720p50,		// 1280x720p 50Hz
	
	VIDOUT_1280x720p30,		// 1280x720p 30Hz
	VIDOUT_1280x720p25,		// 1280x720p 25Hz
	VIDOUT_1280x720p24,		// 1280x720p 24Hz
	...
	VIDOUT_1920x1080p59,		// 1920x1080p 59.94Hz
	VIDOUT_1920x1080p50,		// 1920x1080p 50Hz

	VIDOUT_1920x1080p30,		// 1920x1080p 30Hz
	VIDOUT_1920x1080p25,		// 1920x1080p 25Hz
	VIDOUT_1920x1080p24,		// 1920x1080p 24Hz

	// PC
	VIDOUT_640x480p60,		// 640x480p 60Hz
	VIDOUT_640x480p75,		// 640x480p 75Hz
	VIDOUT_800x600p60,		// 800x600p 60Hz
//	VIDOUT_800x480p60,		// 800x600p 60Hz	//by hungry 2013.05.22 for cmx
	...
	VIDOUT_1366x768p60,			// 1366x768p 60Hz
	VIDOUT_1400x1050p60,			// 1400x1050p 60Hz
...
#define		MDIN_DEINT_PROG_IPC			0x0800	// progressive ipc mode // added on 20Mar2012
...
typedef enum {
	...
	VID_VENC_PAL_60,				// (60) PAL system
	VID_VENC_SECAM,				// SECAM system
	VID_VENC_AUTO,					// Auto Detection
	VID_VENC_NOTVALID,			// not Valid
...
typedef enum {
	AUDIO_DELAY_MODE_16_ALL = 0,
	AUDIO_DELAY_MODE_64_ONE,
	AUDIO_DELAY_MODE_32_ALL,
	AUDIO_DELAY_MODE_128_ONE
...
typedef	enum {
	...
	MDIN_4CHVIEW_CH12_V,		// 4CH-display is dual ch01/ch02 screen
	MDIN_4CHVIEW_CH34_V,		// 4CH-display is dual ch03/ch04 screen
}	MDIN_4CHVIEW_MODE_t;
...
typedef	struct
{
	WORD	coef[5];		// coefficients of color-tone filter

}	stPACKED MDIN_COLORTON_COEF, *PMDIN_COLORTON_COEF;
...
extern ROMDATA MDIN_COLORTON_COEF MDIN_ColorTonFilter_Default[];
extern ROMDATA MDIN_AUXFILT_COEF MDIN_AuxDownFilter_Default[];
extern ROMDATA MDIN_AUXFILT_COEF MDIN_AuxFilterCoef[];		// added on 16Aug2012
...
MDIN_ERROR_t MDIN3xx_SetAuxBGColor(void);
