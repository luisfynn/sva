...
static void NVP6011_PLLInit(PNCDEC_INFO pINFO)
{
...
static void AHD_TX_1280X720P30(PNCDEC_INFO pINFO)
{
	BYTE i;
...
static void AHD_TX_1280X720P25(PNCDEC_INFO pINFO)
{
	BYTE i;
...
void NVP6011_CommonInit(PNCDEC_INFO pINFO)
{
	...
	(pINFO->vformat)?	AHD_TX_1280X720P25(&ncDec) : AHD_TX_1280X720P30(&ncDec);
	...
	xprintf("NVP6011 initialize complete\r\n");
