...
MDIN_ERROR_t MDIN3xx_SetDeintMode(PMDIN_VIDEO_INFO pINFO, MDIN_DEINT_MODE_t mode)
{
	...
	if(pINFO->stSRC_a.frmt == VIDSRC_1280x720p30 || pINFO->stSRC_a.frmt == VIDSRC_1280x720p25 )
		MDINHIF_RegField(MDIN_LOCAL_ID, 0x210, 12, 2, 0x03);
	else
		MDINHIF_RegField(MDIN_LOCAL_ID, 0x210, 12, 2, 0x01);
