...
#define RX_DEVICE           7611  /*Set the Target Rx  device. Tv Driver supports the following devices: 7844, 7842, 7604, 7840, 7612, 7611, 7614, 7622/3, 7619 */
#define RX_USER_CONFIG         1  /*Always set to 1 when using ADI REP Middleware and ADI REP Application. */
#define RX_USER_INIT           1  /*Always set to 0. Set to 1 for customer initialisation custimization only. */
